    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="/">
                <img src="/sparic/build/assets/images/brand/logo.png" class="header-brand-img main-logo" alt="Pindogo logo">
                <img src="/sparic/build/assets/images/brand/logo.png" class="header-brand-img darklogo" alt="Pindogo logo">
                <img src="/sparic/build/assets/images/brand/logo.png" class="header-brand-img icon-logo" alt="Pindogo logo">
                <img src="/sparic/build/assets/images/brand/logo.png" class="header-brand-img icon-logo2" alt="Pindogo logo">
            </a>
        </div>
        <!-- logo-->
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="side5">
                                        <ul class="sidemenu-list">
                                            ...
                                            <li><a href="{{route('activeUsers') }}" class="slide-item"> Active Users</a></li>
                                            <li><a href="{{route('pendingUsers') }}" class="slide-item"> Pending Users</a></li>
                                            <li><a href="{{route('bannedUsers') }}" class="slide-item"> Banned Users</a></li>
                        ...
                        <li class="panel sidetab-menu">
                            ...
                            <div class="panel-body tabs-menu-body p-0 border-0">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="side5">
                                        <ul class="sidemenu-list">
                                            <li><a href="{{route('allUsers') }}" class="slide-item">All Groups</a></li>
                                            <li><a href="{{route('activeUsers') }}" class="slide-item">Paid Groups</a></li>
                                            <li><a href="{{route('pendingUsers') }}" class="slide-item">Free Groups</a></li>
                                            <li><a href="{{route('bannedUsers') }}" class="slide-item">Temporarily Deleted Groups</a></li>
                                            <li><a href="{{ route('usersAnalytics') }}" class="slide-item">Analytics</a></li>
