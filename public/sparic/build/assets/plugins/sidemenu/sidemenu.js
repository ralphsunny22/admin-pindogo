...
currentWidth .push(window.innerWidth);
function responsive() {
    if (window.innerWidth >= 992) {
...
$(window).resize(
    () => {
        ...
        if (window.innerWidth >= 992 && prevValue < 992 || window.innerWidth >= 992) {
            ...
            if(document.body.classList.contains('sideicon-menu', 'icontext-menu')){
                $('body').addClass('sidenav-toggled');
            }
            if(document.body.classList.contains('double-menu')){
                $('body').removeClass('sidenav-toggled');
            }
            if(document.body.classList.contains('double-menu-tabs')){
                $('body').removeClass('sidenav-toggled');
            }
        }
        else{
        ...
        if(window.innerWidth <= 991 && prevValue > 991){
            if(document.body.classList.contains('sideicon-menu', 'icontext-menu')){
                $('body').removeClass('sidenav-toggled');
            }
        }
